...
Recently proposed distributed schedulers (e.g., Sparrow~\cite{ousterhout2013sparrow})
...
scheduling each phase separately. Current task exeuction involves fetching data
...
read input data for future datas from disk or over the network when resources are
...
over taks life time, using many types of resources. instead of traditional thing,
...
Tiny tasks funamentally change the resource footprint of tasks, giving the framework
