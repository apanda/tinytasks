...
\subfigure[Today's tasks] {
    \includegraphics[width=0.2\textwidth]{figures/slot_diagram_before}
    \label{fig:tiny_diagram_original}
}
\subfigure[Tiny tasks] {
    \includegraphics[width=0.2\textwidth]{figures/slot_diagram_after}
...
We use a Facebook trace to quantify how much job response time would
