...
\eat{
Omega, Google's cluster scheduler, uses more flexible coarse grained partitioning.
Services like Dremel~\cite{melnik2010dremel} spin up long-running agents to serve
incoming queries, rather than scheduling new resources for each request.
Omega closely monitors resource usage on each 
Many clusters use static partitioning 
