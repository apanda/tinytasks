...
\begin{document}
\title{\vspace{-1in}The Case for \begin{large}tinyTasks\end{large} in Compute Clusters}
\author{Kay Ousterhout, Aurojit Panda, Josh Rosen, Shivaram Venkataraman, \\Sylvia Ratnasamy, Scott Shenker, Ion Stoica \\ \textit{UC Berkeley}}
\date{}
