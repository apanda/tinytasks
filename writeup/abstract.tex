...
user-facing jobs seen in today's clusters, since even tasks for batch jobs
complete quickly.  Furthermore, tiny tasks avoid the need for complex skew
mitigation techniques: by breaking a large job into millions of tiny tasks, work
can be evenly spread over available resources by the scheduler. Thus, tiny tasks
allow for increased utilization without sacrificing responsiveness or fairness.
...
that complete in hundreds of milliseconds. 
Tiny tasks avoid the need for
